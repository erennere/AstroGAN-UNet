...
def poisson_noise(name,ratio = 2,exp = None, xx = None, yy = None, ps = None, ron = 3, dk = 7, sv_name = None, path = None, patch_noise = False, ret = True, save = False, type_of_image='SCI'):
    img_data = name #e/sec
    ...
    if save:
        save_fits(noise_img, sv_name, path, type_of_image=type_of_image)
    if ret:    
        return noise_img
